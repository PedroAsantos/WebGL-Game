...
function drawWorld(){
  ...
  mat4.rotate( app.mvMatrix, degToRad( app.angle), [0,0,1] );
  mat4.rotate( app.mvMatrix, degToRad( app.angle), [0,0,0 ] );
  mat4.translate(app.mvMatrix, [0.0, 0.0, -13.3]);
